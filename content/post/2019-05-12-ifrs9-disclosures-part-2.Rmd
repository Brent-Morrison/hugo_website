...
Fistly, we need to prepare data for Merton model.  The three inputs are Market cap, debt and equity return volatilty.  We do not have equity volatility.
...
simfin.m <- simfin.m %>% 
  mutate(MertonDD = log(1/(TotalDebt / (TotalDebt + mkt.cap))) / 

...
```
Extract the current status of the yield curve with respect to the level and change bins just created.  This bloke of code will call out the current status of each of the three level / change bins. 

...
We continue on our quest on IFRS9 disclosures!
...
Rename variables to align with the code implemented [here](https://github.com/Brent-Morrison/Financial_reporting/blob/master/Fin_reporting.R).

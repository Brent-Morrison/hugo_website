...
knitr::opts_chunk$set(error=FALSE, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE, fig.height=6.375, fig.width=8.5)
```
...
***The code behind this post can be found [here](https://brent-morrison.github.io/ref-library/mixed_effect_stock_valuation.html).***  
...
[2] Paul-Christian Burkner. Advanced Bayesian Multilevel Modeling with the R Package brms. 2018  
